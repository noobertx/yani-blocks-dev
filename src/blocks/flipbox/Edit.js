                    ...
                    <InspectorTab key='normal'>
                    	...
                    	<PanelBody title={'Effects'} initialOpen={false}>
								<SelectControl label={__('Effect')}  value={hoverEffects}
				                    options={[
				                        { label: __('None'), value: '' },
				                        { label: __('Flip Left'), value: 'flip-box--flip-left' },
				                        { label: __('Flip Right'), value: 'flip-box--flip-right' },
				                        { label: __('Flip Top'), value: 'flip-box--flip-top' },
				                        { label: __('Flip Bottom'), value: 'flip-box--flip-bottom' },
				                    ]}
